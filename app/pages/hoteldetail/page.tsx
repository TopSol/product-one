    ...
    <div>
      ...
      <div className="md:container mx-auto flex flex-col lg:flex-row mt-16 ">
              ...
              <div key={index}>
                <div onClick={() => handleClick(index)}>
                  <img
                    src={src}
                    alt=""
                    className="w-[170px] h-[100px] rounded-lg cursor-pointer "
                  />
                </div>
              </div>
            ))}
                    ...
                    <div className="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
                      <div className="relative z-[1] block rounded-lg bg-[hsla(0,0%,100%,0.55)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[25px] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:px-12 lg:-mr-14">
                        ...
                        <p className="mb-6 text-neutral-500 dark:text-neutral-300">
                          ...
                          malesuada neque iaculis malesuada. Aenean gravida
                          magna orci, non efficitur est porta id. Donec magna
                          diam.
                        </p>
                        <p className="mb-6 text-neutral-500 dark:text-neutral-300">
                          Ad, at blanditiis quaerat laborum officia incidunt
                          cupiditate dignissimos voluptates eius aliquid minus
                          voluptatibus atque vero repellat sit eligendi autem
                          maiores quasi cum aperiam. Aperiam rerum culpa
                          accusantium, ducimus deserunt aliquid alias vitae
        ...
        <div className="lg:w-[30%] ml-5">
          ...
          <div>
            <Calendar  className="rounded flex flex-row"
              localizer={localizer}
              events={events}
              component={Component}
              startAccessor="start"
