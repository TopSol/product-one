...
//   console.log(user,"sdfsfsdfsdfsdfsdfdsfsdfdsfsdfsdfsf")
...
//     };
//     try {
//       await setDoc(doc(db, "Dish", venueId), users);
...
//     }));
//   };
//    console.log(user,"useruserdsfsdf")
//   const hideModal = () => {
//     setOpen(false);
//   };
...
//     }
//   };
//   console.log(Dishes, "dishdddddes");
...
console.log(Menus,"Menuesdfsdf")
  ...
  const update = async (venueId) => {
    ...
    //   discount: user.discount,
    //   discountAmount: discountAmount,
    //   discountedPrice: user.totalDiscount,
    // };
