...
// import {DayPicker} from "@/app/component/Calender";
...
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faCalendarDays,faPerson, faBed,faMap,faStar,faAngleDown } from "@fortawesome/free-solid-svg-icons";
...
function Marqueedetail() {
  ...
  const handleButton = () => {
    ...
    router.push('/pages/details', dataJsonString);
  };
...
console.log(data, "dataasfhalkjf");
  return (
    <div>
      <Navbar />
      <div className="bg-bgColor mt-24">
      ...
      <div className="md:container mx-auto flex flex-col lg:flex-row mt-16 ">
        ...
        <div className="lg:w-[30%] ml-5">
          ...
          <div onClick={handleButton} className="flex bg-bgColor rounded-lg justify-center p-3">
           Book Now
          </div>
