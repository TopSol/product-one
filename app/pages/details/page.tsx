...
function Slider() {
  ...
  const [marqueeData, setMarqueeData] = useState<{venues:Array<Object>,withoutVenueDish:Array<Object>,dish:Array<Object>}>({
    venues: [], 
    withoutVenueDish: [], 
    dish:[],
  });
  ...
  const [newData, setNewData] = useState<{venues:Array<Object>,withoutVenueDish:Array<Object>,dish:Array<Object>}>({
    venues: [], 
    withoutVenueDish: [], 
    dish:[],
  });;
