...
function details() {
  ...
  const [landLineNumber,setLandLineNimber]=useState()
...
console.log(details,"detailsdetails")
  ...
  const handleRegistration = async () => {
    ...
    try {
      ...
      console.log(userInfo,"userInfosss")
   ...
   console.log(value,"valuevalue",landLineNumber)
  useEffect(() => {
    const handleResize = () => {
  ...
  const handleInputChange = (event) => {
    ...
    if (autocomplete && query) {
      autocomplete.getPlacePredictions(
        ...
        (predictions, status) => {
          console.log(predictions,status,"predictionw")
          if (status === "OK") {
      ...
      <div className=" md:container mx-auto">
        ...
        <div className="w-full my-3">
            ...
            >
              ...
              <div className="w-[82%] flex flex-col items-start relative px-5 md:px-0 mb-4 ">
              ...
              <div className="w-[82%] flex flex-col items-start justify-center  relative px-5 md:px-0 ">
        ...
        {predictions.length > 0 && (
          <ul
            className="w-[90%] px-12 md:w-[77%] md:mx-auto flex flex-col justify-center"
            style={{
              position: "absolute",
              zIndex: 1000,
