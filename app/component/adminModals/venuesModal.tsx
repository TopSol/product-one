...
function VenuesModal({ modalOpen, setModalOpen,HandleaddVenue,handleSubmit, updateVenue, openEditVenue, handleCheckboxChange, plainOptions, loading, handleChange, user, setUser }) {
