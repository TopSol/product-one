...
//   // console.log(startAfterDoc, "startAfterDocstartAfterDoc");
//   // const itemsPerPage = 4;
//   const [startAfterDoc, setStartAfterDoc] = useState(null);
//   const [isNextPage, setIsNextPage] = useState(true);
//   const [currentIndex, setCurrentIndex] = useState(0);
//   const itemsPerPage = 2;
//   const hasNextPage = currentIndex + itemsPerPage < userData.length;
...
//     //     } else {
//     //       setUserData([...userData, ...blogData]);
//     //     }
//     //     console.log(blogData[blogData.length - 1].data.createdAt, "ddd");
//     //     setStartAfterDoc(blogData[blogData.length - 1].data.createdAt);
//     //   } else {
//     //     setIsNextPage(false);
...
//     // scrollToTop();
//     console.log("asdf", hasPreviousPage);
//     if (hasPreviousPage) {
//       setCurrentIndex(currentIndex - itemsPerPage);
//       setIsNextPage(true);
//     }
//   };
//   console.log(setCurrentIndex, setIsNextPage, "sdfd");
//   // const handleNextPage = () => {
//   //   // scrollToTop();
//   //   getUser(startAfterDoc);
//   // };
...
//   // const handlePreviousPage = () => {
//   //   // scrollToTop();
//   //   // getUser(firstDocOfCurrentPage);

//   //   if (userData?.length === itemsPerPage) {
//   //     console.log(userData[0]?.data?.createdAt, "jjj");
//   //     const firstDocOfCurrentPage = userData[0]?.data?.createdAt;
//   //     console.log("hhh");
//   //     getUser(firstDocOfCurrentPage);
//   //   }
//   // };
...
//                 // disabled={userData.length <= itemsPerPage}
//               >
//                 &lt;&lt; Previous
//               </button>
//               <button
//                 onClick={() => handleNextPage()}
//                 className={`py-3 px-4 bg-primary text-white  cursor ml-3 `}
//                 // disabled={!isNextPage}
//               >
//                 Next &gt;&gt;
//               </button>
